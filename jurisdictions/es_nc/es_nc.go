// Package es_nc registers Navarre healthcare scheduling regulations.
// SNS-O (Servicio Navarro de Salud-Osasunbidea) is the regional health service.
package es_nc
	...
	return []*comply.RuleDef{
		{
			...
			Name:        "Annual Ordinary Hours (SNS-O)",
			Description: "Annual ordinary working hours for SNS-O statutory personnel.",
			...
			Values: []*comply.RuleValue{
				{Since: comply.D(2020, time.January, 1), Amount: 1592, Unit: comply.Hours, Per: comply.PerYear},
			},
			Source: comply.Source{
				Title:   "SNS-O (Servicio Navarro de Salud-Osasunbidea)",
				Section: "Jornada ordinaria anual",
				URL:     "https://www.navarra.es/es/salud",
			},
		},
		{
			Key:         comply.RuleMinWeeklyRest,
			Name:        "Minimum Weekly Rest (SNS-O)",
