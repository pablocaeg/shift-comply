// Package es_ib registers Balearic Islands healthcare scheduling regulations.
// IB-Salut (Servei de Salut de les Illes Balears) is the regional health service.
package es_ib
	...
	return []*comply.RuleDef{
		{
			...
			Name:        "Annual Ordinary Hours (IB-Salut)",
			Description: "Annual ordinary working hours for IB-Salut statutory personnel.",
			...
			Source: comply.Source{
				Title:   "IB-Salut (Servei de Salut de les Illes Balears)",
				Section: "Jornada ordinaria anual",
				URL:     "https://www.ibsalut.es/",
			},
		},
		{
			Key:         comply.RuleMinWeeklyRest,
			Name:        "Minimum Weekly Rest (IB-Salut)",
