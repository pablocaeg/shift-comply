// Package us_la registers Louisiana healthcare scheduling regulations.
// Louisiana has no state-specific healthcare scheduling laws beyond
	...
	return []*comply.RuleDef{
		{
			...
			Description: "Louisiana does not prohibit mandatory overtime for nurses or other healthcare workers.",
			...
			Source: comply.Source{
				Title:   "Louisiana Department of Labor",
		...
		},
		{
			...
			Description: "Louisiana does not require meal or rest breaks for adult workers.",
