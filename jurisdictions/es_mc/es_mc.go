// Package es_mc registers Murcia healthcare scheduling regulations.
// SMS (Servicio Murciano de Salud) is the regional health service.
package es_mc
	...
	return []*comply.RuleDef{
		{
			...
			Name:        "Annual Ordinary Hours (SMS)",
			Description: "Annual ordinary working hours for SMS statutory personnel.",
			...
			Source: comply.Source{
				Title:   "SMS (Servicio Murciano de Salud)",
				Section: "Jornada ordinaria anual",
				URL:     "https://www.murciasalud.es/",
			},
		},
		{
			Key:         comply.RuleMinWeeklyRest,
			Name:        "Minimum Weekly Rest (SMS)",
