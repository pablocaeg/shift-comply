// Package us_ga registers Georgia healthcare scheduling regulations.
// Georgia has no state-specific healthcare scheduling laws beyond
	...
	return []*comply.RuleDef{
		{
			...
			Description: "Georgia does not prohibit mandatory overtime for nurses or other healthcare workers.",
		...
		},
		{
			...
			Description: "Georgia does not require meal or rest breaks for adult workers.",
