// Package us_hi registers Hawaii healthcare scheduling regulations.
// Hawaii has no state-specific healthcare scheduling laws beyond
	...
	return []*comply.RuleDef{
		{
			...
			Description: "Hawaii does not prohibit mandatory overtime for nurses or other healthcare workers.",
			...
			Source: comply.Source{
				Title:   "Hawaii Department of Labor",
		...
		},
		{
			...
			Description: "Hawaii does not require meal or rest breaks for adult workers.",
