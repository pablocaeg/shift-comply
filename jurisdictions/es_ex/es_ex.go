// Package es_ex registers Extremadura healthcare scheduling regulations.
// SES (Servicio Extremeno de Salud) is the regional health service.
package es_ex
	...
	return []*comply.RuleDef{
		{
			...
			Name:        "Annual Ordinary Hours (SES)",
			Description: "Annual ordinary working hours for SES statutory personnel.",
			...
			Source: comply.Source{
				Title:   "SES (Servicio Extremeno de Salud)",
				Section: "Jornada ordinaria anual",
				URL:     "https://saludextremadura.ses.es/",
			},
		},
		{
			Key:         comply.RuleMinWeeklyRest,
			Name:        "Minimum Weekly Rest (SES)",
