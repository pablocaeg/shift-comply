	...
	return []*comply.RuleDef{
		{
			...
			Source: comply.Source{
				...
				Section: "No mandatory overtime prohibition enacted",
		...
		},
		{
			...
			Source: comply.Source{
				...
				Section: "No state daily overtime statute",
		...
		},
		{
			...
			Source: comply.Source{
				...
				Section: "S 450.081(4) (minors only, no adult requirement)",
				URL:     "http://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0400-0499/0450/0450.html",
			},
		},
		{
			...
			Source: comply.Source{
				Title:   "Florida Department of Economic Opportunity",
				Section: "No state rest break statute",
				URL:     "https://floridajobs.org/",
			},
		},
		{
			...
			Source: comply.Source{
				Title:   "Florida Department of Economic Opportunity",
				Section: "No state day of rest statute",
				URL:     "https://floridajobs.org/",
			},
		},
	}
