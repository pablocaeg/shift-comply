// Package us_wy registers Wyoming healthcare scheduling regulations.
// Wyoming has no state-specific healthcare scheduling laws beyond
	...
	return []*comply.RuleDef{
		{
			...
			Description: "Wyoming does not prohibit mandatory overtime for nurses or other healthcare workers.",
			...
			Source: comply.Source{
				Title:   "Wyoming Department of Labor",
		...
		},
		{
			...
			Description: "Wyoming does not require meal or rest breaks for adult workers.",
