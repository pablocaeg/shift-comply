// Package us_ar registers Arkansas healthcare scheduling regulations.
// Arkansas has no state-specific healthcare scheduling laws beyond
	...
	return []*comply.RuleDef{
		{
			...
			Description: "Arkansas does not prohibit mandatory overtime for nurses or other healthcare workers.",
			...
			Source: comply.Source{
				Title:   "Arkansas Department of Labor",
		...
		},
		{
			...
			Description: "Arkansas does not require meal or rest breaks for adult workers.",
