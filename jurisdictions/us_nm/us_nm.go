// Package us_nm registers New Mexico healthcare scheduling regulations.
// New Mexico has no state-specific healthcare scheduling laws beyond
	...
	return []*comply.RuleDef{
		{
			...
			Source: comply.Source{
				Title:   "New Mexico Department of Labor",
