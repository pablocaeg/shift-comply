...
// Michigan has no state-specific healthcare scheduling laws beyond
	...
	return []*comply.RuleDef{
		{
			...
			Source: comply.Source{
				Title:   "Michigan Department of Labor",
		...
		},
		{
			...
			Description: "Michigan does not require meal or rest breaks for adult workers.",
