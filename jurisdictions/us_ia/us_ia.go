// Package us_ia registers Iowa healthcare scheduling regulations.
// Iowa has no state-specific healthcare scheduling laws beyond
	...
	return []*comply.RuleDef{
		{
			...
			Description: "Iowa does not prohibit mandatory overtime for nurses or other healthcare workers.",
			...
			Source: comply.Source{
				Title:   "Iowa Department of Labor",
		...
		},
		{
			...
			Description: "Iowa does not require meal or rest breaks for adult workers.",
