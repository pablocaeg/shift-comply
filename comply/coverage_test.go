...
func TestGenerateConstraints_AllTypes(t *testing.T) {
	...
	for _, code := range []comply.Code{comply.US, comply.USCA, comply.USNY, comply.USTX, comply.USFL, comply.USMA, comply.USIL, comply.USOR, comply.EU, comply.ES, comply.ESCT, comply.ESMD} {
